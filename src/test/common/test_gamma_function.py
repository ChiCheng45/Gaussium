...
class TestBoysFunction(TestCase):
    ...
    def test_input_of_nu_2_and_u_130_80051761256559_returns_3_3969e_minus_6(self):
        output = BoysFunction.function(2, 130.80051761256559)
