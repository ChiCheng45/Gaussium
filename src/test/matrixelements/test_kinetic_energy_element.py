...
class TestKineticEnergyIntegralHydrogen(TestCase):
    ...
    def setUp(self):
        hydrogen_basis_1 = MagicMock(contraction=0.15432897, exponent=3.42525091, coordinates=(0, 0, -0.7000), integral_exponents=(0, 0, 0))
        hydrogen_basis_2 = MagicMock(contraction=0.53532814, exponent=0.62391373, coordinates=(0, 0, -0.7000), integral_exponents=(0, 0, 0))
        hydrogen_basis_3 = MagicMock(contraction=0.44463454, exponent=0.16885540, coordinates=(0, 0, -0.7000), integral_exponents=(0, 0, 0))
        hydrogen_basis_4 = MagicMock(contraction=0.15432897, exponent=3.42525091, coordinates=(0, 0, 0.7000), integral_exponents=(0, 0, 0))
        hydrogen_basis_5 = MagicMock(contraction=0.53532814, exponent=0.62391373, coordinates=(0, 0, 0.7000), integral_exponents=(0, 0, 0))
        hydrogen_basis_6 = MagicMock(contraction=0.44463454, exponent=0.16885540, coordinates=(0, 0, 0.7000), integral_exponents=(0, 0, 0))
        hydrogen_basis_1.normalisation.return_value = 1.794441832218435
        hydrogen_basis_2.normalisation.return_value = 0.5003264923314032
        hydrogen_basis_3.normalisation.return_value = 0.18773545851092535
        hydrogen_basis_4.normalisation.return_value = 1.794441832218435
        hydrogen_basis_5.normalisation.return_value = 0.5003264923314032
        hydrogen_basis_6.normalisation.return_value = 0.18773545851092535
