...
from src.main.selfconsistentfield import UHFSCFProcedure
import numpy as np
import time
...
class UnrestrictedHartreeFock:
    ...
    def begin():
        ...
        start = time.clock()
        print('*******************************************************************************************************')
        print('\nA BASIC QUANTUM CHEMICAL PROGRAM IN PYTHON: UHF\n\n')
        ...
        print('\nBEGIN SCF PROCEDURE')
        scf_procedure = UHFSCFProcedure(h_core_matrix, x_canonical, matrix, electrons, repulsion_dictionary)
        electron_energy = scf_procedure.begin_scf(orbital_coefficients, 3)
