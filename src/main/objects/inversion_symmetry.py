class InversionSymmetry:
    ...
    def operate(self, coordinate):
        """Returns the inversion symmetry operation on a coordinate through the origin.
    ...
    def int_operate(self, coordinate):
        """Returns the inversion symmetry operation on a coordinate but returns a tuple of ints.
