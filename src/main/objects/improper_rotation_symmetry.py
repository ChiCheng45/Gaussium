...
class ImproperRotationSymmetry:
    ...
    This class can only create axis of improper rotation that go through the origin. As the reflection plane of the
    improper rotation will go through the origin, it is therefore equivalent to rotation and inversion. This operator
    will instead rotate and invert as the code is simpler and does not need the creation of the householder matrix used
    in reflection operations.
