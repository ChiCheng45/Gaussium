...
class ChachiyoCorrelation(CorrelationPotential):
    """Chachiyo correlation potential.
    ...
    """
    def calculate(self, density):
        """Returns the value of the Chachiyo correlation potential for a given density.
        ...
        """
        if density not in self.potential_memo:
            r_s = self.wigner_seitz_radius(density)
            self.potential_memo[density] = -0.0155453 * log(1 + (20.4562557 / r_s) + (20.4562557 / r_s**2)) \
            - ((0.0155453 * 20.4562557 * (2 + r_s)) / (3 * (20.4562557 * r_s + 20.4562557 + r_s**2)))
        return self.potential_memo[density]
