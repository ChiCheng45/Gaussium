class TotalEnergy:
    ...
    @staticmethod
    def restricted(density_matrix, h_core_matrix, fock_matrix):
    ...
    @staticmethod
    def unrestricted(density_matrix_total, density_matrix_alpha, density_matrix_beta, h_core_matrix, fock_matrix_alpha, fock_matrix_beta):
        a = density_matrix_total.shape[0]
        total_energy = 0
        for i in range(a):
            for j in range(a):
                out1 = density_matrix_total.item(i, j) * h_core_matrix.item(i, j)
