...
class DIIS:
    """Direct Inversion in the Iterative Subspace for improved
    SCF convergence.
    ...
    linear_algebra : LinearAlgebra
        Object containing the transformation matrix and linear
        algebra related methods
    fock_array : List
        A list of guess fock matrices.
    error_array : List
        A list of the error vectors.
    diis_subspace : int
        Max size of the DIIS subspace can get before it gets cleared
        and restarted.
    begin : bool
    ...
    def fock_matrix(self, fock, density):
        """Runs DIIS and return a the Fock matrix or a DIIS optimized
        Fock matrix.
    ...
    def create_b_matrix(self):
        ...
        Occasionally there can be an issues with the b_matrix becoming
        singular. This methods corrects itself by removing a fock
        matrix and error vector and trying again.
