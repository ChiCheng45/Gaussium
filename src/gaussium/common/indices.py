...
class Indices:
    """Convenience functions that yield indices for excitation of a
    electron from an occupied to unoccupied orbital.

    Correlated methods such as MP2 and CCSD can inherit from this
    class and can use the methods in the following manner,
    ...
    this example shows mp2 guess singles and doubles amplitudes
    calculated for CCSD calculations.
