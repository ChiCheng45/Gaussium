...
class Matrix:
    """Class for creating matrices efficiently by only calculating the
    triangular matrix and reflecting.
    ...
    def create_matrix(self, function):
        """Create matrix method that takes in a function to calculate
        the matrix elements.
